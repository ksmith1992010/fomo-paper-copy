...
- A new buy spends 8% of that trader's remaining sleeve, and never more than cash on hand. If that amount is under $1, or the sleeve is already spent, the buy is skipped. Idle sleeve cash left on wallets that are no longer on the board moves to the wallets that are. Cash already inside an open lot stays there.
